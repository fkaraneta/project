...
<body>
		...
		<div class="header-search">
			...
			<input type="text" name="search" placeholder="Search..."><button class="btnsearch" value = ""><i class="fa fa-search"></i></button>
	...
	<?php		
		...
		?>		
				...
				<td><?php echo "₱ ".$item["prod_price"]; ?> x<?php echo $item["quantity"]?> <a href="Search.php?action=remove&code=<?php echo $item["code"]; ?>" class="btnRemoveAction">Delete</a></td></tr>
	...
	?>		
			...
			<form method="post" action="Search.php?action=add&code=<?php echo $value["code"]; ?>">
			<div class ="main">
					...
					<div><input type="hidden" class="product-quantity" name="quantity" value="1" size="2" /><button value="Add to Cart" class="btn btn4" action=""/>Add to Cart</button></div>	
			</div>
			</form>

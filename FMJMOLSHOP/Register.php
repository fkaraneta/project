...
<body>
		...
		<div class="register">
			...
			<tr><td <?php if(isset($name_error) || isset($emailErrormsg)): ?> class="form_error" <?php endif?>>
			<input type="text" name="fname" class="reg" required></tr>
			</td>
			<tr><td>
			<label>Last Name</label></tr>
			</td>
			<tr><td>
			<input type="text" name="lname" class="reg" required></tr>
			</td>
			<tr><td>
			<label>Contact</label></tr>
			</td>
			<tr><td>
			<input type="text" name="contact" class="reg" required></tr>
			</td>
			<tr><td>
			<label>Username</label></tr>
			</td>
			<tr><td>
			...
			<tr><td>
			<input type="text" name="email" class="reg" required></tr>
			</td>
			<tr><td>
			<label>Password</label></tr>
			</td>
			<tr><td>
			<input type="password" name="password" id="my" class="reg"></tr>
			</td>
			<tr><td>
	        <input type="checkbox" class="input" onclick="myFunction()">Show Password</tr>
			</td>
			<tr><td>
			<button type="submit" name="submit" class="submit">Register</button></tr>
			</td>
			</form>
					</table>
					</center>
